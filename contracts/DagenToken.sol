    ...
    function showStoreItems() external view returns (string memory) {
        return
            string(abi.encodePacked(
                ...
                "Selection 1. ", storeItems[1].name, " (Cost: ", uint2str(storeItems[1].cost), " DGN)\n",
                "Selection 2. ", storeItems[2].name, " (Cost: ", uint2str(storeItems[2].cost), " DGN)\n",
                "Selection 3. ", storeItems[3].name, " (Cost: ", uint2str(storeItems[3].cost), " DGN)"
            ));
    }
